fn main() {
    ...
    let n4 = n1 + &n2 + &n3;//n2 & n3 referrence is passed 

    //About Electrical /Electronic
    println!("\nThe {} is informed by the aspirations to
     train electrical/electronic engineering professionals
    in the area of design, building and maintenance of electrical control systems,",n4);


    let w1 = "Computer".to_string();
    let w2 = "Science".to_string();
    let w3 = w1 + &w2;   // w2 referrence is passed 
    println!();
